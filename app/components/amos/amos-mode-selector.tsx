...
interface AmosModeSelector {
  onModeSelect: (mode: "manual" | "automatic") => void
}

export default function AmosModeSelector({ onModeSelect }: AmosModeSelector) {
  return (
    <div className="max-w-6xl mx-auto">
      <div className="text-center mb-16">
        <h2 className="text-4xl font-semibold text-gray-900 mb-4">Choose AMOS Processing Mode</h2>
        <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
          Select how you want to process monitoring data from PowerTrack and Locus Energy
        </p>
      </div>
            ...
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <div>
                ...
                <CardDescription className="text-gray-600 text-base leading-relaxed">
                  Configure monitoring data extraction step-by-step with full control over settings
                </CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent className="px-8 pb-8">
            <div className="flex items-center justify-center pt-4 border-t border-gray-100">
              <div className="flex items-center space-x-2 text-[#699B1F] group-hover:text-[#699B1F] transition-colors">
                <span className="text-sm font-medium">Configure Platform</span>
          ...
          <CardHeader className="p-8 pb-6">
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <div>
                ...
                <CardDescription className="text-gray-600 text-base leading-relaxed">
                  Automated monitoring data extraction with intelligent scheduling for both platforms
                </CardDescription>
              </div>
            </div>
          </CardHeader>
